...
def main_page():
    st.write(
        """
        <div style="font-family: Arial; font-size: 22px; color: white; line-height: 1.5;">
...
def Heart_rate():
    ...
    image = Image.open("D:\学习文件\pycharmproject\新建文件夹\streamlit_echarts\dc.jpg")
...
def Nutrition():
    ...
    st.write("")
    # 从CSV文件中读取数据
    df = pd.read_csv("D:\学习文件\pycharmproject\project2\streamlit_echarts\营养数据.csv")
    ...
    image1 = Image.open("D:\学习文件\pycharmproject\新建文件夹\streamlit_echarts\shiwu1.jpg")
    image2 = Image.open("D:\学习文件\pycharmproject\新建文件夹\streamlit_echarts\shiwu2.jpg")
...
def Weight():
    ...
    image = Image.open("D:\学习文件\pycharmproject\新建文件夹\streamlit_echarts\yundong.jpg")
    st.image([image], caption=['food'], width=300)
